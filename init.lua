...
-- Set left  and right arrows to move to the begginning and end of the line
vim.keymap.set('n', '<right>', '$', { desc = 'Move to the end of the line' })
vim.keymap.set('n', '<left>', '^', { desc = 'Move to the beginning of the line' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- If encountering errors, see README for installation instructions
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gr', require('telescope.builtin').lsp_references, '[]oto [R]eferences')
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  You could rmove this setup call if you don't like it,
